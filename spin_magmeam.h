...
class MAGMEAM {
 ...
 public:
  ...
  void meam_dens_update(int i, int ntype, int *type, int *fmap, double **x, double **sp, int numneigh,
			int *firstneigh, int numneigh_full, int *firstneigh_full, int fnoffset, double cutoffsq);
  ...
  void update_dens_final(int i, int ntype, int *type, int *fmap, double **scale, int &errorflag, double cutoffsq);
